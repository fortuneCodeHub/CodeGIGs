<x-layout>
    ...
    <x-auth-card-position>
        <div class="text-center auth-header">
            ...
            <small class="text-black">Edit Gig</small>
            <br>
            <small class="text-black fs-6">Edit: {{$listing->title}}</small>
        </div>
        <form action="../../listing/{{$listing->id}}" method="POST" enctype="multipart/form-data" >
            ...
            <div>
                ...
                <div class="join-group d-flex align-items-center">
                    ...
                    <div class="float-input">
                        <input type="text" value="{{$listing->company}}" name="company" class="input" id="floatingInput">
                    </div>
                </div>
                @error('company')
            ...
            <div>
                ...
                <div class="join-group d-flex align-items-center">
                    <span class="bg-white input-text"><i class="bi bi-person-badge"></i></span>
                    <div class="float-input">
                        <input type="text" name="title" value="{{$listing->title}}" class="input" id="floatingInput" placeholder="Example: Senior Laravel Developer">
                    </div>
                </div>
                @error('title')
                    <p class="text-danger fs-6 fw-bold">* {{$message}}</p>
            ...
            <div>
                ...
                <div class="join-group d-flex align-items-center">
                    ...
                    <div class="float-input">
                        <input type="text" value="{{$listing->location}}" name="location" class="input" id="floatingInput" placeholder="Example: Ikeja, Lagos city, Nigeria">
                    </div>
                </div>
                @error('location')
                    <p class="text-danger fs-6 fw-bold">* {{$message}}</p>
            ...
            <div>
                ...
                <div class="join-group d-flex align-items-center">
                    ...
                    <div class="float-input">
                        <input type="text" value="{{$listing->email}}" name="email" class="input" id="floatingInput">
                    </div>
                </div>
                @error('email')
                    <p class="text-danger fs-6 fw-bold">* {{$message}}</p>
            ...
            <div>
                ...
                <div class="join-group d-flex align-items-center">
                    ...
                    <div class="float-input">
                        <input type="url" value="{{$listing->website}}" name="website" class="input" id="floatingInput">
                    </div>
                </div>
                @error('website')
                    <p class="text-danger fs-6 fw-bold">* {{$message}}</p>
            ...
            <div>
                ...
                <div class="join-group d-flex align-items-center">
                    ...
                    <div class="float-input">
                        <input type="text" value="{{$listing->tags}}" name="tags" class="input" id="floatingInput" placeholder="Example: Laravel, Backend, API, Vue">
                    </div>
                </div>
                @error('tags')
                    <p class="text-danger fs-6 fw-bold">* {{$message}}</p>
            ...
            <button class="mt-3 w-100 btn btn-lg bg-orange text-white" type="submit">Edit GIG</button>
