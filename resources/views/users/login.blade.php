<x-layout>
    ...
    <x-auth-card-position>
        <div class="text-center auth-header">
            ...
            <small class="text-black">Log in to your account now</small>
        </div>
        <form action="{{route("authenticate")}}" method="POST" enctype="multipart/form-data" >
            ...
            <button class="mt-3 w-100 btn btn-lg bg-orange text-white goal" type="submit">Log In</button>
            <div class="text-center mb-3 mt-2">
                <p>Dont have an account?
                    <a href="{{route("register")}}" class="text link" style="text-decoration: none;">Signup</a>
                </p>
                <p>
                    <a href="{{route("checkemail")}}" class="text link" style="text-decoration: none;">Forgot Password</a>
                </p>
